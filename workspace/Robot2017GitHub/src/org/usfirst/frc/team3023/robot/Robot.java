...
//        chooser.addObject("My Auto", new MyAutoCommand());
    ...
    public void autonomousInit() {
		...
		switch(autoSelected) {
		case "Left Peg":
			autonomousCommand = new AutoRun(1, 1, 0);
			break;
		case "Middle Peg then Stop":
		default:
			autonomousCommand = new AutoRun(2, 0, 0);
			break;
		case "Middle Peg then Cross Left":
			autonomousCommand = new AutoRun(2, 1, 1);
			break;
		case "Middle Peg then Cross Right":
			autonomousCommand = new AutoRun(2, 1, 0);
			break;
		case "Right Peg":
			autonomousCommand = new AutoRun(3, 1, 0);
			break;
		} 
